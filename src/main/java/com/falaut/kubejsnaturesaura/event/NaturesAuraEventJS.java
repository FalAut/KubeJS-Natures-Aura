...
public class NaturesAuraEventJS implements KubeEvent {
    ...
    public void modify(ResourceLocation dimension, String auraType) {
        ((BasicAuraType) NaturesAuraAPI.AURA_TYPES.get(ResourceLocation.parse(auraType))).addDimensionType(dimension);
    }
